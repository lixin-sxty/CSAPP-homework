...
void t1(long n) { sink = aprod1(a, n); }

void t2(long n) { sink = aprod2(a, n); }

void t3(long n) { sink = aprod3(a, n); }

void t4(long n) { sink = aprod4(a, n); }

void t5(long n) { sink = aprod5(a, n); }
