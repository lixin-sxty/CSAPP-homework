...
int cpy_ls_r(a, l, mx, it) double *a;
int l, mx, it;
{
  long nn;
            ...
            if ((unsigned int)hx >= stop) {
              DEBUGPRINT {
                printf("mx %d:  hx %d, a %d, diff %d\n", mx, hx, a,
                       (int)((unsigned int)hx - (unsigned int)a));
                fflush(stdout);
              }
              ax = ay;
              m = l;
            ...
            if ((unsigned int)dx >= stop) {
              DEBUGPRINT {
                printf("mx %d:  dx %d, a %d, diff %d\n", mx, dx, a,
                       (int)((unsigned int)dx - (unsigned int)a));
                fflush(stdout);
              }
              ax = ay;
              m = l;
  ...
  if (nn > 16) {
    gettime(&hi0, &lo0);
    {
      ...
      for (k = 0; k < it; k++) {
        ay = a;
        cy = c;
        cystop = (unsigned int)cy + MAXREMOTE;
        DEBUGPRINT {
            ...
            if ((unsigned int)cy >= cystop) {
              DEBUGPRINT {
                printf("mx %d:  cy %d, c %d, diff %d\n", mx, cy, c,
                       (int)((unsigned int)cy - (unsigned int)c));
                fflush(stdout);
              }
              cy = c;
            }
